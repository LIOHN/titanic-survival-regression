...
# categorical missing value imputer - predefined
...
class ExtractFirstLetter(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        X = X.copy()
        for feature in self.variables:
            X[feature] = X[feature].str[0] # captures the first letter
        
        return X

# frequent label categorical encoder - predefined
...
# string to numbers categorical encoder - predefined
